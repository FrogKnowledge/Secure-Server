...
namespace X509.Crypto
{
    internal class Win32Native
    {
        ...
        [DllImport("AdvApi32.dll", CharSet = CharSet.Unicode, EntryPoint = "CryptAcquireContextW", ExactSpelling = true, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool CryptAcquireContext(out IntPtr providerContext, string containerName, string providerName, int providerType, int flags);
        ...
        [DllImport("AdvApi32.dll", ExactSpelling = true, SetLastError = true)]
        [return: MarshalAs(UnmanagedType.Bool)]
        internal static extern bool CryptGenKey(IntPtr providerContext, int algorithmId, uint flags, out IntPtr cryptKeyHandle);
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool FileTimeToSystemTime([In] ref long fileTime, [Out] Win32Native.SystemTime systemTime);
    }
}
